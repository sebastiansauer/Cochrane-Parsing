...
```{r test-parse-review}
bad_url <- "https://www.cochranelibrary.com/cdsr/doi/10.1002/14651858.CD008720.pub2/full"
test_review <- parse_review(bad_url, 
                            overwrite = TRUE,
                            reviewer = "?",
...
reviews_all_50 <- 
  ...
  map2_dfr(.x = dois_by_reviewer_sample$url,
...
review_ss <- 
  dois_ss %>% 
  map_dfr(parse_review, .id = "id_review", output_dir = "output/ss",
          overwrite_file = FALSE,
          reviewer = "ss")
```
