...
cochrane_url <- dois_reviews_2017[1]
cochrane_url <- "https://doi.org/10.1002/14651858.CD009326.pub3"
...
```{r}
write_csv(reviews_parsed2, 
            file = paste0("test_reviews_infos2", ".csv"))

writexl::write_xlsx(reviews_parsed2,
                    path = "test_reviews_infos2.xlsx")
```
